...
-- *****************************************************************************
-- Generated on "10/25/2018 04:15:33"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          ShiftDireita
-- 
...
ENTITY ShiftDireita_vhd_vec_tst IS
END ShiftDireita_vhd_vec_tst;
ARCHITECTURE ShiftDireita_arch OF ShiftDireita_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL SAIDA : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL VALOR : STD_LOGIC_VECTOR(15 DOWNTO 0);
COMPONENT ShiftDireita
	PORT (
